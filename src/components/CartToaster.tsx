...
import { CartItem, getCart } from "src/lib/cart";
      ...
      <div className="cart-toast__body">
        ...
        <div>
          ...
          <div className="cart-toast__price">
            {item.price
              ? new Intl.NumberFormat("uk-UA").format(item.price) + " ₴"
              : "Ціну уточнюйте"}
          </div>
          <div className="cart-toast__total">
            Разом у кошику: {new Intl.NumberFormat("uk-UA").format(total)} ₴
          </div>
        </div>
      </div>
