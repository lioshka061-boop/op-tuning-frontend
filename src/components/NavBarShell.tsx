import { loadCarCategories, type CategoryNode } from "src/lib/categories";
import { loadProducts, plainText } from "src/lib/products";
import { slugify } from "src/lib/slug";
import { NavBar } from "./NavBar";

function buildCarCategories(
...
export default async function NavBarShell() {
  ...
  const carCategories =
    carCategoriesRaw.length > 0
      ? carCategoriesRaw
      : buildCarCategories(
          await loadProducts({ limit: 30, compact: true }, { revalidate: 300 }),
        );
