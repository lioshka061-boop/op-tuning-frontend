    ...
    const t = window.setTimeout(async () => {
      try {
        const res = await fetch(
          `/api/products?q=${encodeURIComponent(q)}&limit=6&compact=true`,
          {
            cache: "no-store",
          },
        );
          ...
          <div className="mobile-icon-row">
            ...
            <div className="mobile-icon-actions">
              ...
              <a
                ...
                href="#mobile-car"
                aria-label="Підібрати авто"
              >
                <i className="ri-car-line"></i>
                {garageCount > 0 && (
                  <span className="action-badge">{garageCount}</span>
                )}
              </a>
      ...
      <div id="mobile-menu" className="mobile-sheet">
        <div className="mobile-sheet__panel">
          ...
          <nav className="mobile-menu-links">
            <Link href="/catalog" onClick={handleMobileNavClick}>
              Каталог
            </Link>
            <Link href="/new" onClick={handleMobileNavClick}>
              Новинки
            </Link>
