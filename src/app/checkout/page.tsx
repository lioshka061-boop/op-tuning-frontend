...
import { clearCart, getCart, CartItem, removeFromCart } from "src/lib/cart";
import { SimpleTopbar } from "src/components/SimpleTopbar";
    ...
    const t = window.setTimeout(async () => {
      try {
        ...
        const res = await fetch(
          `/api/novaposhta/cities?q=${encodeURIComponent(cityQuery.trim())}`,
          {
  ...
  useEffect(() => {
    ...
    const t = window.setTimeout(async () => {
      try {
        ...
        setNpError("");
        const res = await fetch(
          `/api/novaposhta/warehouses?cityRef=${encodeURIComponent(form.city)}`,
          {
            signal: controller.signal,
          },
        );
    ...
    <>
      ...
      <main className="page no-footer">
        <section className="categories">
          <nav
            className="breadcrumbs checkout-breadcrumbs"
              ...
              <div className="checkout-panel">
                    ...
                    <div className="checkout-grid">
                      <label>
                        ...
                        >
                          ...
                          <option value="nova-poshta-branch">
                            Нова пошта (на відділення)
                          </option>
                          <option value="nova-poshta-courier">
                            Нова пошта (курʼєр)
                          </option>
                  ...
                  <div className="checkout-stage">
                    ...
                    <div className="checkout-payments">
                      ...
                      <label className="payment-installment">
                        ...
                        Оплата частинами
                        <span className="payment-note">
                          72% клієнтів обрали цей метод
                        </span>
                        <span className="payment-amount">
                          {new Intl.NumberFormat("uk-UA").format(
                            Math.ceil((total * 1.15) / 10),
                          )}{" "}
                          ₴/міс.
                        </span>
                      </label>
                  ...
                  <form className="checkout-stage" onSubmit={submit}>
                    ...
                    <div className="checkout-checks">
                      <label>
                        ...
                        />
                        Я хочу отримувати інформацію про товари, новинки та
                        акції на пошту
                      </label>
                      <label>
                        <input
                ...
                {step === 5 && (
                  <div className="checkout-stage checkout-thanks">
                    ...
                    <p>
                      Ми отримали вашу заявку та звʼяжемось найближчим часом.
                    </p>
                    <a className="primary" href="/catalog">
