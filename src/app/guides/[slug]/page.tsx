...
import { loadProductsWithMeta, plainText } from "src/lib/products";
import { filtersFromPayload, loadSeoPage } from "src/lib/seo-pages";

const PAGE_TYPE = "guides";
const PAGE_LABEL = "Гайд";
const PER_PAGE = 24;
...
export async function generateMetadata({
  ...
  const robotsValue =
    page.robots || (page.indexable ? "index,follow" : "noindex,follow");
...
export default async function GuidesSeoPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
    ...
    <main className="page seo-page">
        ...
        <div className="seo-hero-copy">
          ...
          {page.seo_text && (
            <div
              ...
              dangerouslySetInnerHTML={{ __html: page.seo_text }}
            />
          )}
        </div>
        {showPanel && (
      ...
      {hasFilters && (
        <section>
          ...
          <ProductInfiniteGrid
            ...
            resetKey={resetKey}
            emptyTitle="Порожньо"
            emptyText="Для цього гайду поки немає товарів."
          />
        </section>
      )}
      ...
      {page.faq && (
        <section className="seo-copy">
          ...
          <div
            className="desc-block"
            dangerouslySetInnerHTML={{ __html: page.faq }}
          />
        </section>
      )}
    </main>
