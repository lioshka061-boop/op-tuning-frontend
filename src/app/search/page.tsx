...
import { loadProductsWithMeta } from "src/lib/products";
...
export function generateMetadata(): Metadata {
  return {
    title: "Пошук товарів",
    description:
      "Каталог товарів з фільтрами по бренду, моделі та категорії. Параметричні сторінки не індексуємо.",
...
export default async function SearchPage({
  ...
  const [{ items, total }, carCategories, productCategories] =
    await Promise.all([
