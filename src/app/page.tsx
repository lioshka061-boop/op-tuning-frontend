...
import { NewArrivalsSlider } from "src/components/NewArrivalsSlider";
...
function matchCategoryImage(products: Product[], name: string) {
  ...
  const match = products.find((product) => {
    ...
    return tokens.some(
      (token) => category.includes(token) || title.includes(token),
    );
  });
...
export default async function Home() {
  const [products, hitsProducts, productCategories, carCategories] =
    await Promise.all([
      loadProducts({ limit: 30, compact: true }, { revalidate: 300 }),
      loadProducts(
        { limit: 24, compact: true, hit: true },
        { revalidate: 300 },
      ),
    ...
    <main className="page">
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-content">
          <h1>
            Тюнінг запчастини для автомобілів — обвіси, фари, оптика, аксесуари
          </h1>
          <p>
            Підбір під авто, чесні ціни та швидка доставка по Україні —
            допоможемо знайти ідеальну деталь під вашу комплектацію.
          </p>
        ...
        <div className="benefits-grid">
          <div className="benefit-card">
            ...
            <div>
              ...
              <p>
                Працюємо з офіційними постачальниками та перевіреними брендами.
              </p>
            </div>
          </div>
          <div className="benefit-card">
      ...
      <section className="home-seo-text">
        ...
        <p>
          У нас можна купити тюнінг для <a href="/catalog/bmw/e46">BMW E46</a>,{" "}
          ...
          <a href="/catalog/mercedes/w447">Mercedes W447</a> та багатьох інших
          моделей. Для кожної категорії доступні обвіси, бампери, оптика,
          решітки та аксесуари з доставкою по Україні.
        </p>
      </section>
      ...
      <section className="home-faq">
        ...
        <div className="faq-list">
          <details open>
            ...
            <p>
              Перевіряємо сумісність за маркою, моделлю, роком і комплектацією
          ...
          <details>
            ...
            <p>
              Середній термін 1–2 дні, точні строки залежать від виробника та
              складу.
            </p>
          </details>
          <details>
            ...
            <p>
              Так, на всі позиції діє гарантія виробника та наш сервісний
              супровід.
            </p>
          </details>
          <details>
            ...
            <p>
              Доступна оплата частинами для більшості товарів — уточнюйте під
              час замовлення.
            </p>
          </details>
          <details>
            ...
            <p>
              Для складних елементів рекомендуємо сервісну установку, щоб
              зберегти гарантію.
            </p>
          </details>
        </div>
